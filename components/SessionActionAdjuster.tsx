...
export default function SessionActionAdjuster({
  ...
  function replace(source: Exercise, target: ExercisePreset) {
    ...
    addExercise(date, target, { intent: source.trainingIntent ?? "context" });
    setEditingId(null);
