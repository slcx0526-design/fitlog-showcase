...
export default function PulseSessionConsole() {
  ...
  return <section className="pulse-session-console mb-3" aria-label="训练行动面板" data-no-pulse>
    <div className="pulse-console-top"><span className="pulse-live-dot" aria-hidden="true" /><span>行动面板</span><span>进行中</span><span className="tnum ml-auto">{formatSetCredit(summary.completionCredits)}{summary.plannedSets > 0 ? ` / ${summary.plannedSets}` : ""} 组</span></div>
