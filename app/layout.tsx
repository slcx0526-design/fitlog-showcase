...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return <html lang="zh-CN" data-mode="lite" suppressHydrationWarning><head><link rel="preconnect" href="https://fonts.googleapis.com" /><link rel="preconnect" href="https://fonts.gstatic.com" crossOrigin="anonymous" /><link href="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500;600&family=IBM+Plex+Sans:wght@400;500;600;700&family=IBM+Plex+Sans+SC:wght@400;500;600;700&display=swap" rel="stylesheet" /><script dangerouslySetInnerHTML={{ __html: "(function(){try{var m=localStorage.getItem('fitlog:uiMode'),mode=(m==='pulse'||m==='midnight'||m==='survival')?m:'lite';document.documentElement.setAttribute('data-mode',mode);}catch(e){document.documentElement.setAttribute('data-mode','lite');}})();" }} /></head><body><BootSignal /><ErrorBoundary><StoreProvider><I18nProvider><UIModeProvider><ToastProvider><div className="mx-auto flex min-h-[100dvh] max-w-app flex-col"><main className="app-main"><MidnightModeControl />{children}</main></div><BottomNav /><ServiceWorkerRegistrar /></ToastProvider></UIModeProvider></I18nProvider></StoreProvider></ErrorBoundary></body></html>;
}
