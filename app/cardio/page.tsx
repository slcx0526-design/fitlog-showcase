    ...
    <div>
      <header className="mb-4">
        ...
        <div className="control-card p-3.5">
          ...
          <h1 className="mt-1 text-[24px] font-bold tracking-tight text-fg">
            {isPast ? tr("补记有氧") : tr("有氧")}
          </h1>
          <p className="mt-1 text-[12px] leading-relaxed text-muted">
            {formatDisplay(date, locale)}{isPast ? " · 补记不会改动今日预算" : " · 看周目标与强度，不用单次热量兑换食物"}
          </p>
        </div>
      </header>

      <CardioModule date={date} />
    </div>
  );
}
